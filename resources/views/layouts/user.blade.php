...
<head>
    ...
    <meta name="description" content="user panel for Applications">
    <meta name="author" content="backstage">

    <link rel="shortcut icon" href="assets/images/favicon.ico">

    <title>Stock-Exchange - User Dashboard</title>
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="/user" class="logo"><span>Stock Exchange</span></span><i class="zmdi zmdi-layers"></i></a>
                </div>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="{{ url('users/dashboard')}}" class="waves-effect"><i class="zmdi zmdi-view-dashboard"></i> <span> Dashboard </span> </a>
                            </li>

                           <li class="has_sub">
                               <a href="{{ url('users/personal')}}" class="waves-effect"> <i class="fa fa-file"></i> <span>Personal Data</span></a>
                           </li>
                            <li class="has_sub">
                               <a href="{{ url('users/verification')}}" class="waves-effect"> <i class="fa fa-file"></i> <span>Verification</span></a>
                           </li>
                

                           <li class="has_sub">
                               <a href="{{ url('users/portfolio')}}" class="waves-effect"> <i class="fa fa-file"></i> <span>Portfolio</span></a>
                           </li>
                            <!-- <li><a href="{{ url('users/credit_card')}}"> <i class="fa fa-maxcdn"></i> Credit_card</a></li> -->


                           <li class="has_sub">
                               <a href="{{ url('users/withdra-funds')}}" class="waves-effect"> <i class="fa fa-file"></i> <span>Withdra Funds</span></a>
                           </li>

                           <li class="has_sub">
                               <a href="{{ url('users/balance')}}" class="waves-effect"> <i class="fa fa-file"></i> <span>Balance History</span></a>
                           </li>
                               
                           <li class="has_sub">
                               <a href="{{ url('users/trading-history')}}" class="waves-effect"> <i class="fa fa-file"></i> <span>Trading History</span></a>
                           </li>
                               
                           <li class="has_sub">
                               <a href="{{ url('users/contact-support')}}" class="waves-effect"> <i class="fa fa-file"></i> <span>Contact Support</span></a>
                           </li>


                            <!-- {{-- <li><a href="{{ url('users/seo')}}"> <i class="fa fa-file"></i> SEO</a></li>
                            <li><a href="{{ url('user/cars')}}"> <i class="fa fa-car"></i> Car List</a></li>
                            <li><a href="{{ url('user/accessories')}}"> <i class="fa fa-cog"></i> Car Accessories</a></li> --}}
                            {{-- <li><a href="{{ url('user/slider_img')}}"> <i class="fa fa-arrows-h"></i> Slider Images</a></li> --}}
                            {{-- <li><a href="{{ url('user/services')}}"> <i class="fa fa-cog"></i> Services</a></li> --}}
                            {{-- <li><a href="{{ url('user/slider_images')}}"> <i class="fa fa-arrows-h"></i> Slider Images</a></li>
                            <li><a href="{{ url('user/services')}}"> <i class="fa fa-cog"></i> Services</a></li> --}}
                            {{-- <li class="has_sub">
                               ...
                               <ul class="list-unstyled">
                                   <li><a href="{{ url('user/complains')}}">Complains</a></li>
                                   <li><a href="{{ url('user/requests')}}">Request Queries</a></li>
                                   <li><a href="{{ url('user/callbacks')}}">Callback Queries</a></li>
                                   <li><a href="{{ url('user/contacts')}}">Contact Queries</a></li>
                                   <li><a href="{{ url('user/ondemand')}}">On Demand Queries</a></li>
                                   <li><a href="{{ url('user/feedbacks')}}">Feedback Queries</a></li>
                               </ul>
                           </li> --}}
                           {{-- 
                           <li class="has_sub">
